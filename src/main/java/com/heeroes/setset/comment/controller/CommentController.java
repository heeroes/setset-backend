...
public class CommentController {
    ...
    public ResponseEntity<Response<String>> create(@PathVariable int groupId, @PathVariable int articleId, @RequestBody Comment comment, @RequestHeader("Authorization") String tokenHeader){
